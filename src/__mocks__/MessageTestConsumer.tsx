...
const MessageTestConsumer = (): JSX.Element => {
	const { conversations, messages, currentConversationId, messageError, messageDispatch } =
	...
	const setMessageError = (): void => {
		messageDispatch({
			type: 'setMessageError',
			payload: 'New Message Error'
		})
	}
	...
	return (
		<div>
			...
			<button onClick={setMessageError}>Set Message Error</button>
		</div>
	)
}
