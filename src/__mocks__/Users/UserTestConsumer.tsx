...
const UserTestConsumer = (): JSX.Element | null => {
	...
	const { userError, workingUser, loggedInUser, formFields, userEditState, userDispatch } =
		useUserStateContext()
	...
	const triggerError = (): void => {
		userDispatch({ type: 'setUserError', payload: 'New Login Error' })
	}
	...
	return (
		<div>
			<span>Any errors here: {userError}</span>
